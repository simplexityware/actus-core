...
public class POF_PP_PAM implements PayOffFunction {
    ...
    ContractModel model, RiskFactorProvider riskFactors, DayCountCalculator dayCounter, BusinessDayAdjuster timeAdjuster) {
        ...
        ContractRoleConvention.roleSign(model.contractRole) * 
        riskFactors.stateAt(model.objectCodeOfPrepaymentModel,time) * states.nominalValue;
        }
}
