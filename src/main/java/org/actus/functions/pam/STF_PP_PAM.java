...
public class STF_PP_PAM implements StateTransitionFunction {
    ...
    ContractModel model, RiskFactorProvider riskFactors, DayCountCalculator dayCounter, BusinessDayAdjuster timeAdjuster) {
        ...
        states.nominalValue -= riskFactors.stateAt(model.objectCodeOfPrepaymentModel,time) * states.nominalValue;
