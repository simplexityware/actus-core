...
public class LinearAmortizerTest {
    ...
    public void test_LAM_events_inWindow_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        MarketModel riskFactors = new MarketModel();
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.events(analysisTimes,model,riskFactors);
        //System.out.println(events);
    }
    ...
    public void test_LAM_events_inPeriod_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        MarketModel riskFactors = new MarketModel();
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.events(LocalDateTime.parse("2016-01-01T00:00:00"),Period.ofWeeks(1),model,riskFactors);
        //System.out.println(events);
    }
    ...
    public void test_LAM_transactions_inWindow_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        MarketModel riskFactors = new MarketModel();
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.transactions(analysisTimes,model,riskFactors);
        //System.out.println(events);
    }
    ...
    public void test_LAM_transactions_inPeriod_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        MarketModel riskFactors = new MarketModel();
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.transactions(LocalDateTime.parse("2016-01-01T00:00:00"),Period.ofWeeks(1),model,riskFactors);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_lifecycle_withIP_withRR_withSC_withOP_withIPCB_withMultipleAnalysisTimes() {
        ...
        analysisTimes.add(LocalDateTime.parse("2016-09-01T00:00:00"));
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.lifecycle(analysisTimes,model);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_payoff_withIP_withRR_withSC_withOP_withIPCB_withMultipleAnalysisTimes() {
        ...
        analysisTimes.add(LocalDateTime.parse("2016-09-01T00:00:00"));
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.payoff(analysisTimes,model);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_events_inWindow_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        MarketModel riskFactors = new MarketModel();
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.events(analysisTimes,model);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_events_inPeriod_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        ContractModel model = ContractModel.parse(map);
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.events(LocalDateTime.parse("2016-01-01T00:00:00"),Period.ofWeeks(1),model);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_transactions_inWindow_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        analysisTimes.add(LocalDateTime.parse("2016-09-01T00:00:00"));
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.transactions(analysisTimes,model);
        //System.out.println(events);
    }
    ...
    public void test_LAM_noncontingent_transactions_inPeriod_withIP_withRR_withSC_withOP_withIPCB() {
        ...
        ContractModel model = ContractModel.parse(map);
        // lifecycle LAM contract
        ArrayList<ContractEvent> events = LinearAmortizer.transactions(LocalDateTime.parse("2016-01-01T00:00:00"),Period.ofWeeks(1),model);
        //System.out.println(events);
    }
}
