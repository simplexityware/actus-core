...
public class StockTest {
    ...
    public void test_STK_MandatoryAttributes() {
        ...
        // eval PAM contract
        ArrayList<ContractEvent> events = Stock.eval(analysisTimes,model,riskFactors);
    }
    
    @Test
    public void test_STK_withDV() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "STK");
        map.put("Calendar", "NoHolidayCalendar");
    ...
    @Test
    public void test_STK_withDV_withPRD() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "STK");
        map.put("Calendar", "NoHolidayCalendar");
    ...
    @Test
    public void test_STK_withDV_withPRD_withTD() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "STK");
        map.put("Calendar", "NoHolidayCalendar");
    ...
    @Test
    public void test_STK_withDV_withPRD_withMultipleAnalysisTimes() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "STK");
        map.put("Calendar", "NoHolidayCalendar");
