...
public class ForeignExchangeOutrightTest {
    ...
    @Test
    public void test_FXOUT_schedule_MandatoryAttributes() {
        ...
        // compute schedule
        ArrayList<ContractEvent> schedule = ForeignExchangeOutright.schedule(LocalDateTime.parse(map.get("MaturityDate")),model); 
        ...
        // apply events
        ArrayList<ContractEvent> events = ForeignExchangeOutright.apply(schedule,model,riskFactors);
    }
    
    @Test
    public void test_FXOUT_schedule_whithDeliverySettlement_whereS() {
        thrown = ExpectedException.none();
        // define attributes
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
    ...
    @Test
    public void test_FXOUT_schedule_whereS_withSTD() {
        thrown = ExpectedException.none();
        // define attributes
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
    ...
    @Test
    public void test_FXOUT_schedule_withPRD() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
        map.put("StatusDate", "2016-01-01T00:00:00");
    ...
    @Test
    public void test_FXOUT_schedule_withPRD_withTD() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
        map.put("StatusDate", "2016-01-01T00:00:00");
    ...
    @Test
    public void test_FXOUT_schedule_withPRD_withTD_withSTD() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
        map.put("StatusDate", "2016-01-01T00:00:00");
    ...
    @Test
    public void test_FXOUT_schedule_withSTD_withMultipleAnalysisTimes() {
        thrown = ExpectedException.none();
        Map<String, String> map = new HashMap<String, String>();
        map.put("ContractType", "FXOUT");
        map.put("StatusDate", "2016-01-01T00:00:00");
